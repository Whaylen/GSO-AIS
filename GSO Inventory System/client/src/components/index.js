...
export default {
  ...
  PageLimiter: defineAsyncComponent(() => import("./others/tPageLimiter.vue")),
  Pager: defineAsyncComponent(() => import("./others/tPager.vue")),
  PageSearchEmpty: defineAsyncComponent(() =>
    import("./others/pageSearchEmpty.vue")
  ),
  ...
  TRicked: defineAsyncComponent(() => import("./others/ricked.vue")),
  // End - Others

  // Viewers
  TPdf: defineAsyncComponent(() => import("./viewers/pdf/index.vue")),
  TPdfVuer: defineAsyncComponent(() => import("./viewers/pdf/pdfVuer.vue")),
  TPdfSidebar: defineAsyncComponent(() => import("./viewers/pdf/pdfSidebar.vue")),
  TPdfPasswordPrompt: defineAsyncComponent(() => import("./viewers/pdf/pdfPasswordPrompt.vue")),
  TPdfPageRenderer: defineAsyncComponent(() => import("./viewers/pdf/pdfPageRenderer.vue")),
  TPdfBookmarks: defineAsyncComponent(() => import("./viewers/pdf/outline/index.vue")),
  TPdfAttachments: defineAsyncComponent(() => import("./viewers/pdf/attachments/index.vue")),
  // End - Viewers
};
