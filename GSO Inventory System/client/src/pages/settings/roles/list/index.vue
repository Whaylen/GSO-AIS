        ...
        >
          <template #append>
            <TButton
              ...
              iconSize="sm"
              class="rounded-full"
              @click="(tmpSearch = null), emit('update:search', null)"
            />
            <TButton
              icon="search"
    ...
    <div class="grid grid-cols-2 md:grid-cols-3">
      ...
      <div class="flex items-center gap-1 md:justify-center">
        ...
        <Pager
          ...
          :total="_pagination.pages"
          @update:page="(e) => paginator?.changePage(e)"
        />
        <PageLimiter
          v-model="_pagination.limit"
          @update:modelValue="emit('update:search', tmpSearch ?? null)"
        />
      </div>
      <div class="flex items-center justify-end gap-1">
        <TPagination
          ...
          @paginate="(val) => emit('update:search', tmpSearch)"
        />
        <TButton
          icon="refresh"
