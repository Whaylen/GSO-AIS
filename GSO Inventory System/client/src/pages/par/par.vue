            ...
            <table class="table-auto w-full border-collapse border border-gray-300">
                ...
                <tbody>
                    <tr @click="router.push()" v-for="par in pars">
                        ...
                        <td class="border border-gray-300 px-4 py-2">Feature not available</td>
                        <td class="border border-gray-300 px-4 py-2">{{ par.article }}</td>
                        <td class="border border-gray-300 px-4 py-2">{{ par.brand_model }}</td>
                        <td class="border border-gray-300 px-4 py-2">{{ par.particulars }}</td>
                        <td class="border border-gray-300 px-4 py-2">{{ par.responsibility_center }}</td>
